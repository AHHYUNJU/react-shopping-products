...
const PAGEABLE_DEFAULT$1 = {
  page: 0,
  size: 20,
  sort: ""
};
async function getShoppingCart(pageable = PAGEABLE_DEFAULT$1) {
  const { page, size, sort } = pageable;
  const token2 = "QUhIWVVOSlU6cGFzc3dvcmQ";
  const baseUrl2 = "http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com";
  const params = new URLSearchParams({
    page: String(page),
    size: String(size),
    sort: sort ?? ""
  });
  const response = await fetch(`${baseUrl2}/cart-items?${params}`, {
    method: "GET",
...
function APIProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(APIContext.Provider, { value: { data, setData }, children });
}
function useAPI({
  fetcher,
  name
  ...
  const request = reactExports.useCallback(async () => {
    ...
    try {
      ...
      setStatus("error");
      setErrorMessage(
        err instanceof Error ? err.message : `${name}을 불러오는 중 알 수 없는 오류가 발생했습니다.`
      );
    }
...
const StyledDiv$1 = newStyled.div`
  display: flex;
...
`;
const StyledSpan$1 = newStyled.span`
  font-weight: 500;
  font-size: 12px;
  color: #0a0d13;
`;
...
newStyled.div`
  ...
  gap: 8px;
`;
const ModalHeaderTitle = newStyled.span`
  display: flex;
  justify-content: space-between;
  align-items: center;
  width: 67px;
  ...
  padding: 10px;
`;
const Modalimg = newStyled.img`
  width: 80px;
  height: 80px;
  border-radius: 8px;
`;
const ModalItemInfo = newStyled.div`
  flex: 1;
  display: flex;
  flex-direction: column;
  gap: 8px;
  position: relative;
`;
const ModalTitle = newStyled.span`
  max-width: 200px;
  height: 19px;
  top: 4px;
  font-weight: 700;
  font-size: 16px;
`;
const ModalItemPrice = newStyled.span`
  max-width: 200px;
  height: 15px;
  font-weight: 500;
  font-size: 12px;
...
const ModalFooter = newStyled.div`
  ...
  padding: 20px 10px;
`;
const ModalFooterTitle = newStyled.span`
  width: 82px;
  height: 16px;
  font-weight: 700;
  font-size: 16px;
`;
const ModalTotalPrice = newStyled.span`
  max-width: 200px;
  font-weight: 700;
  font-size: 24px;
`;
const ModalCloseButton = newStyled.button`
  margin-top: 12px;
  ...
  cursor: pointer;
`;
const ModalDeleteImg = newStyled.img`
  width: 40px;
  height: 24px;
  cursor: pointer;
`;
const ItemHeaderRow = newStyled.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
`;
function ErrorBox({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledDiv$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSpan$1, { children }) });
}
async function deleteShoppingCart(productId) {
  const token2 = "QUhIWVVOSlU6cGFzc3dvcmQ";
  const baseUrl2 = "http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com";
  const response = await fetch(`${baseUrl2}/cart-items/${productId}`, {
    method: "DELETE",
    headers: {
...
const StyledLi = newStyled.li`
  height: 224px;
  border-radius: 8px;
`;
const StyledImgWrapper = newStyled.div`
  width: 100%;
  height: 50%;
...
`;
const StyledProductInfoWrapper = newStyled.div`
  display: flex;
  flex-direction: column;
  width: 100%;
  height: 50%;
  ...
  box-sizing: border-box;
`;
const StyledTitle = newStyled.span`
  font-weight: 700;
  font-size: 14px;
`;
const StyledPrice = newStyled.span`
  font-weight: 500;
  font-size: 12px;
`;
const StyledButton$1 = newStyled.button`
  width: 59px;
  height: 24px;
  padding: 4px 8px;
  gap: 4px;
  ...
  cursor: pointer;
`;
const StyledImg$1 = newStyled.img`
  width: 15px;
  height: 15px;
`;
const StyledProductInfo = newStyled.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
`;
const StyledButtonWrapper = newStyled.div`
  display: flex;
  flex-grow: 1;
  align-items: flex-end;
  justify-content: flex-end;
`;
const StyledQuantityController = newStyled.div`
  display: flex;
  align-items: center;
  gap: 8px;
  cursor: pointer;
`;
const StyledButtonText = newStyled.span`
  font-size: 12px;
  font-weight: 600;
`;
const StyledcontrollButton = newStyled.span`
  width: 24px;
  height: 24px;
`;
const StyledControllImg = newStyled.img`
  display: flex;
  align-items: center;
`;
const StyledSoldOutOvelay = newStyled.div`
  display: flex;
  justify-content: center;
  align-items: center;
  color: white;
...
function QuantityController({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBox, { children: errorMessage }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledQuantityController, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledButtonText, { children: count }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledcontrollButton, { onClick: handleIncrease, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        StyledControllImg,
        {
...
function Modal({ isModalOpen, onClose }) {
  ...
  if (status === "error") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledDiv$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBox, { children: "오류가 발생했습니다. 잠시 후 다시 시도해 주세요." }) });
  }
  ...
  const modalContent = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBackground, { isModalOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModalHeaderTitle, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "장바구니" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBody, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalList, { children: data.content.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalItem, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Modalimg,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalItemInfo, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemHeaderRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ModalTitle, { children: item.product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDelete(item.product.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ModalDeleteImg,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalItemPrice, { children: [
          item.product.price.toLocaleString("ko"),
          "원"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          QuantityController,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModalFooterTitle, { children: "총 결제 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalTotalPrice, { children: [
        totalPrice.toLocaleString("ko-KR"),
        "원"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModalCloseButton, { onClick: onClose, children: "닫기" })
  ] }) }) });
  return reactDomExports.createPortal(modalContent, document.body);
}
const StyledBody = newStyled.div`
  padding: 36px 24px;
  margin: 0px;
  display: flex;
  flex-direction: column;
...
function Body({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledBody, { ...props, children });
}
const StyledCountBox = newStyled.div`
  width: 19px;
  height: 19px;
  background-color: white;
  border-radius: 50%;
...
function CountBox({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledCountBox, { "data-testid": "cart-count-box", children });
}
const StyledHeader = newStyled.header`
  ...
  height: 64px;
`;
const StyledSpan = newStyled.span`
  color: #ffffff;
  font-weight: 800;
`;
...
const StyledImg = newStyled.img`
  ...
  height: 24px;
`;
const StyledCountText = newStyled.span`
  font-weight: 700;
`;
function Header({ onOpenModal }) {
  ...
  const cartCount = ((_a3 = data == null ? void 0 : data.content) == null ? void 0 : _a3.length) ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledHeader, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSpan, { children: "SHOP" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledButton, { type: "button", onClick: onOpenModal, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StyledImg, { src: "/assets/shoppingBagIcon.png", alt: "shoppingBagIcon" }),
      status === "success" && /* @__PURE__ */ jsxRuntimeExports.jsx(CountBox, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(StyledCountText, { "data-testid": "cart-count", children: cartCount }) })
    ] })
  ] });
}
...
async function getProducts(category, pageable = PAGEABLE_DEFAULT) {
  const { page, size, sort } = pageable;
  const baseUrl2 = "http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com";
  const params = new URLSearchParams({
    page: String(page),
  ...
  const response = await fetch(`${baseUrl2}/products?${params}`);
  if (!response.ok) {
...
function Spinner({ size, color }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSpinner, { size, color });
}
const StyledSpinner = newStyled.div`
  width: ${(props) => props.size}px;
  height: ${(props) => props.size}px;
  border: ${(props) => props.size ? `${Math.round(props.size / 10)}px solid rgba(0, 0, 0, 0.1)` : "1px solid black"};
  border-top: ${(props) => props.size ? `${Math.round(props.size / 10)}px solid ${props.color}` : "1px solid black"};
  border-radius: 50%;
  animation: ${rotate} 1s linear infinite;
`;
const StyledUl = newStyled.ul`
  display: grid;
  ...
  gap: 16px;
`;
async function postShoppingCart(productId, quantity) {
  const token2 = "QUhIWVVOSlU6cGFzc3dvcmQ";
  const baseUrl2 = "http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com";
  const response = await fetch(`${baseUrl2}/cart-items`, {
    method: "POST",
    headers: {
      Authorization: `Basic ${token2}`,
      "Content-Type": "application/json"
  ...
  if (!response.ok) {
    ...
    throw new Error(
      (errorData == null ? void 0 : errorData.message) || `상품을 장바구니에 추가하는데 실패했습니다 (${response.status})`
    );
  }
  const data = await response.json();
  return data;
...
function ProductItem({
  ...
  const count = ((_a3 = data == null ? void 0 : data.content.find((item) => item.product.id === id2)) == null ? void 0 : _a3.quantity) || 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledLi, { id: String(id2), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledImgWrapper, { imageUrl, children: quantity === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSoldOutOvelay, { children: "품절" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledProductInfoWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledProductInfo, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StyledTitle, { children: name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledPrice, { children: [
          price.toLocaleString("ko"),
          "원"
        ] })
      ] }),
      quantity !== 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(StyledButtonWrapper, { children: count === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        StyledButton$1,
        {
          onClick: async () => {
            await postShoppingCart(id2, 1);
            refetch();
          },
          "data-testid": `add-btn-${id2}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StyledImg$1,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(StyledButtonText, { children: "담기" })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        QuantityController,
...
function ProductList({ productList }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledUl, { children: productList.map((item) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ProductItem, { ...item }, item.id);
  }) });
}
function useProductFilters(setCategory, setPrice) {
  const onCategoryChange = (e2) => {
    const v2 = e2.target.value;
    setCategory(v2);
  };
  const onPriceChange = (e2) => {
    const v2 = e2.target.value;
    setPrice(v2);
  };
  return { onCategoryChange, onPriceChange };
}
const SelectBoxContainer = newStyled.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`;
...
const Label = newStyled.label`
  ...
  border: 0;
`;
const FirstSelectWrapper = newStyled.div`
  display: flex;
`;
const StyledSelect = newStyled.select`
  width: 125px;
  height: 36px;
  border-radius: 8px;
...
function SelectBox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSelect, { ...props, children: options.map(({ label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value, children: label }, label)) });
}
function ProductListToolbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectBoxContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(FirstSelectWrapper, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "category", children: "카테고리" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectBox,
          {
            value: category,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "price", children: "가격" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectBox,
          {
            value: price,
...
const StyledSpinnerWrapper = newStyled.div`
  width: 100%;
  height: 100%;
  display: flex;
  align-items: center;
...
function ProductListContainer() {
  ...
  const [price, setPrice] = reactExports.useState("low");
  ...
  const {
    ...
    fetcher: () => getProducts(categoryParam, {
      page: 0,
      size: 20,
      sort: sortParam
    }),
  ...
  if (status === "loading" || status === "idle") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledSpinnerWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { size: 100, color: "red" }) });
  }
  if (status === "error") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledDiv, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBox, { children: "오류가 발생했습니다. 잠시 후 다시 시도해 주세요." }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProductListToolbar,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(APIProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) });
}
function AppContent() {
  const [isModalOpen, setIsModalOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { onOpenModal: () => setIsModalOpen(true) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Body, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductListContainer, {}) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isModalOpen, onClose: () => setIsModalOpen(false) })
  ] });
}
    ...
    try {
      ...
      parsedCookies.forEach(([origin, cookies]) => {
        this.store.set(
          origin,
          new Map(
            cookies.map(([token2, { expires, ...cookie }]) => [
              token2,
...
async function enableMocking$1(context, options) {
  var _a3, _b2;
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`,
    ...
    const workerRegistration = startWorkerInstance().then(
      async (registration) => {
        ...
        await enableMocking$1(context, options).catch((error2) => {
  ...
  if (from2 && typeof from2 === "object" || typeof from2 === "function") {
    for (let key of __getOwnPropNames$2(from2))
      if (!__hasOwnProp$2.call(to, key) && key !== except)
        __defProp$3(to, key, { get: () => from2[key], enumerable: !(desc = __getOwnPropDesc$2(from2, key)) || desc.enumerable });
  }
  return to;
};
...
function getAbsoluteUrl(path, baseUrl2) {
  ...
  const origin = baseUrl2 || typeof document !== "undefined" && document.baseURI;
  return origin ? (
...
const productHandler = [
  http.get(`${baseUrl$1}/products`, async ({ request }) => {
    var _a3;
    const url = new URL(request.url);
    const categoryOption = url.searchParams.get("category");
    const priceOption = (_a3 = url.searchParams.get("sort")) == null ? void 0 : _a3.split(",")[1];
    const filteredCategoryProducts = categoryOption === null ? PRODUCT_MOCK_DATA : PRODUCT_MOCK_DATA.filter(
      ({ category }) => category === categoryOption
    );
    const filteredPriceProducts = filteredCategoryProducts.sort(
      (a, b2) => priceOption === "desc" ? b2.price - a.price : a.price - b2.price
    );
...
const shoppingCartHandler = [
  http.get(`${baseUrl}/cart-items`, async ({ request }) => {
    ...
    if (idOption !== null) {
      items = items.filter(({ id: id2 }) => id2 === Number(idOption));
    }
  ...
  http.post(`${baseUrl}/cart-items`, async ({ request }) => {
    ...
    const product = PRODUCT_MOCK_DATA.find((p2) => p2.id === productId);
    if (!product) {
  ...
  http.patch(`${baseUrl}/cart-items/:id`, async ({ request, params }) => {
    ...
    const item = SHOPPING_CART_MOCK_DATA.find(
      (cartItem) => cartItem.product.id === id2
    );
    if (!item) {
      return HttpResponse.json(
